...
//1																												STEPS
//1
//1complete steps for flag red
//1dont get on platform
//1set up at red cap start
//1complete steps for red cap
//1dont get on platform
//1run up to top red cap and flip
//1try to collect a ball from one of the caps
//1 also flip top blue cap
//1then turn to flag blue start
//1complete steps for flag blue start
//1dont get on platform
//1set up at blue cap start
//1run blue cap code
//1finish on platform
/////////////////////////////////////////////////////////////////////////////////////////////////////
//  																							Motors
